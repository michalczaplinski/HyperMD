...
declare global {
    namespace HyperMD {
        ...
        interface Editor {
            hmd: HelperCollection;
        }
    }
}
export declare type cm_t = CodeMirror.Editor;
declare module "codemirror" {
    ...
    function addClass(el: HTMLElement, className: string): any;
    function rmClass(el: HTMLElement, className: string): any;
    function contains(parent: HTMLElement, child: Node): boolean;
    function defineMIME(mime: string, mode: string): any;
    ...
    type BuiltinCommand = "selectAll" | //Select the whole content of the editor.
    ...
    "find" | "findNext" | "findPrev" | "replace" | "replaceAll" | //Not defined by the core library, but defined in the search addon (or custom client addons).
    "newlineAndIndentContinueMarkdownList";
    type Command = keyof CommandFunctions;
    var keyMap: {
        [keymapName: string]: KeyMap;
    };
